...
class AudioIn:
    ...
    def audioInWorker(self):
        ...
        streamIn = pIn.open(format=pyaudio.paInt16, channels=1, rate=self.RATE, input=True, stream_callback=self.callbackIn, frames_per_buffer=int(self.CHUNKSIZE), input_device_index = 1)
